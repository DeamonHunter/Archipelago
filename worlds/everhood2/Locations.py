...
item_locations: Dict[str, Everhood2LocationData] = {    
    ...
    "Anime Hairstyle": Everhood2LocationData(ITEM_LOCATION_START + 7, "Neon City", LocationType.cosmetic, "Anime Hairstyle"),
    "Mage Hat": Everhood2LocationData(ITEM_LOCATION_START + 8, "Neon City", LocationType.cosmetic, "Mage Hat"),
    "Wild Hairstyle": Everhood2LocationData(ITEM_LOCATION_START + 9, "Neon City", LocationType.cosmetic, "Wild Hairstyle"),
    "Backslick Hairstyle": Everhood2LocationData(ITEM_LOCATION_START + 10, "Neon City", LocationType.cosmetic, "Backslick Hairstyle"),
    "Stylish Hairstyle": Everhood2LocationData(ITEM_LOCATION_START + 11, "Neon City", LocationType.cosmetic, "Stylish Hairstyle"),
    "Natural Hairstyle": Everhood2LocationData(ITEM_LOCATION_START + 12, "Neon City", LocationType.cosmetic, "Natural Hairstyle"), 
    "Afro Hairstyle": Everhood2LocationData(ITEM_LOCATION_START + 13, "Neon City", LocationType.cosmetic, "Afro Hairstyle"),
    ...
    "Hotdog": Everhood2LocationData(ITEM_LOCATION_START + 15, "Eternal War - Battlefield", LocationType.cosmetic, "Hotdog"),
    ...
    "Cat Ears": Everhood2LocationData(ITEM_LOCATION_START + 28, "Hillbert Hotel", LocationType.hillbert_cosmetic, "Cat Ears"),
    "Cat Ears Bald": Everhood2LocationData(ITEM_LOCATION_START + 29, "Hillbert Hotel", LocationType.hillbert_cosmetic, "Cat Ears Bald"),
    "Floor Gold Key": Everhood2LocationData(ITEM_LOCATION_START + 30, "Hillbert Hotel", LocationType.hillbert_item, "Floor Gold Key"),
    "Floor Gold Complete Chest": Everhood2LocationData(ITEM_LOCATION_START + 31, "Hillbert Hotel", LocationType.hillbert_item, "50xp"),
    "Oingo Boingo": Everhood2LocationData(ITEM_LOCATION_START + 32, "Hillbert Hotel", LocationType.hillbert_cosmetic, "Oingo Boingo"),
...
battle_locations: Dict[str, Everhood2LocationData] = {
    ...
    "Chase (Bad) Battle": Everhood2LocationData(BATTLE_LOCATION_START + 24, "Marzian Era 0 - Mining Base", LocationType.major_battle, "5xp"),
    ...
    "Dimension Master Battle": Everhood2LocationData(BATTLE_LOCATION_START + 26, "Marzian Era 0 - Mining Base", LocationType.major_battle, "75xp"),
